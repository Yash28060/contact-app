  ...
  return (
    <>
      <div
        ...
        className="bg-white hover:border-blue-500 hover:ring-3 hover:ring-blue-400 outline-none rounded-lg shadow-md p-5 hover:shadow-lg transition-shadow duration-300 cursor-pointer"
      >
